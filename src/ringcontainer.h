...
class ringContainer
{
  public:
    ...
    {
      if ( numberOfParticles > 0 )
        return ( pr2_over_E / numberOfParticles );
      else
        return 0;
    }
    ...
    {
      if ( numberOfParticles > 0 )
        return ( pz2_over_E / numberOfParticles );
      else
        return 0;
    }
    ...
    {
      if ( numberOfParticles > 0 )
        return ( pr_pz_over_E / numberOfParticles );
      else
        return 0;
    }
