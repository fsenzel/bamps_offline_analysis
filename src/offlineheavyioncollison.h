...
//     void computeVelocityOfCells(int cell_index);
    ...
    void scatt23_amongBackgroundParticles_AMYphotons  ( cellContainer& _cells, std::vector< int >& _allParticlesListScattering, std::vector< int >& _allParticlesListBackground, const double scaleFactor, bool& again, const double nexttime , const double volume);
