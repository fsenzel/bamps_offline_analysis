...
: initialModelWS( _config.getA(), _config.getAatomic(), _config.getB(), _config.getBatomic() ), sigmaAbs( _config.getSigmaAbs() ), agN( _config.getJpsiagN() ), shadowing_model( _config.getShadowingModel() ), nEventsAA( _config.getNaddedEvents() ), testparticles( _config.getTestparticles() * _config.getJpsiTestparticles() )
{
  double Tab;
