...
class config : public configBase
{
  public:
    ...
    double getFreezeOutEnergyDensity() const
    {
      return freezeOutEnergyDensity;
    }

    /** @brief Interface for config::scatt_offlineWithAddedParticles */
    bool isScatt_offlineWithAddedParticles() const
    {
      return scatt_offlineWithAddedParticles;
    }

    /** @brief Interface for config::scatt_amongOfflineParticles */
    bool isScatt_amongOfflineParticles() const
    {
      return scatt_amongOfflineParticles;
    }

    /** @brief Interface for config::scatt_amongAddedParticles */
    bool isScatt_amongAddedParticles() const
    {
      return scatt_amongAddedParticles;
    }

    /** @brief Interface for config::scatt_furtherOfflineParticles */
    bool isScatt_furtherOfflineParticles() const
    {
      return scatt_furtherOfflineParticles;
    }

    /** @brief Interface for config::N_light_flavors_input */
    int getNlightFlavorsAdded() const
    {
      return N_light_flavors_input;
    }

    /** @brief Interface for config::N_heavy_flavors_input */
    int getNheavyFlavorsAdded() const
    {
      return N_heavy_flavors_input;
    }
    /** ------------------------------- */

    /** ---- initial state options ---- */
    /** @brief Interface for config::initialStateType */
    INITIAL_STATE_TYPE getInitialStateType() const
    {
      return initialStateType;
    }

    /** @brief Interface for config::PDFsource */
    PDF_SOURCE_TYPE getPDFsource() const
    {
      return PDFsource;
    }

    /** @brief Interface for config::LHAPDFdatasetName */
    string getLHAPDFdatasetName() const
    {
      return LHAPDFdatasetName;
    }

    /** @brief Interface for config::LHAPDFmember */
    unsigned short int getLHAPDFmember() const
    {
      return LHAPDFmember;
    }

    /** @brief Interface for config::LHAPDFuseGrid */
    bool getLHAPDFuseGrid() const
    {
      return LHAPDFuseGrid;
    }

    /** @brief Interface for config::nuclearPDFs */
    bool useNuclearPDFs() const
    {
      return nuclearPDFs;
    }

    /** @brief Interface for config::nuclearPDFdatasetName */
    string getNuclearPDFdatasetName() const
    {
      return nuclearPDFdatasetName;
    }

    /** @brief Interface for config::pythiaParticleFile */
    string getPythiaParticleFile() const
    {
      return pythiaParticleFile;
    }

    /** @brief Interface for config::cgcParticleFile */
    string getCgcParticleFile() const
    {
      return cgcParticleFile;
    }

    /** @brief Interface for config::mcatnloParticleFileCharm */
    string getMcatnloParticleFile() const
    {
      return mcatnloParticleFile;
    }

    /** @brief Interface for config::P0 */
    double getPtCutoff() const
    {
      return P0;
    }

    /** @brief Interface for config::insertionTime */
    double getInsertionTime() const
    {
      return insertionTime;
    };

    /** @brief Interface for config::initialPartonPt */
    double getInitialPartonPt() const
    {
      return initialPartonPt;
    };
    ...
    bool doOutput_progressLog() const
    {
      return outputSwitch_progressLog;
    }

    /** @brief Interface for config::outputSwitch_detailedParticleOutput */
    bool doOutput_detailedParticleOutput() const
    {
      return outputSwitch_detailedParticleOutput;
    }

    /** @brief Interface for config::outputSwitch_movieOutput */
    bool doOutput_movieOutputJets() const
    {
      return outputSwitch_movieOutputJets;
    }

    /** @brief Interface for config::outputSwitch_movieOutput */
    bool doOutput_movieOutputBackground() const
    {
      return outputSwitch_movieOutputBackground;
    }

    /** @brief Interface for config::outputSwitch_scatteredMediumParticlesOutput */
    bool doOutput_scatteredMediumParticles() const
    {
      return outputSwitch_scatteredMediumParticlesOutput;
    }

    /** @brief Interface for config::v2RAAoutput */
    bool isV2RAAoutput() const
    {
      return  v2RAAoutput;
    }

    /** @brief Interface for config::v2RAAoutputIntermediateSteps */
    bool isV2RAAoutputIntermediateSteps() const
    {
      return v2RAAoutputIntermediateSteps;
    }

    /** @brief Interface for config::dndyOutput */
    bool isDndyOutput() const
    {
      return  dndyOutput;
    }

    /** @brief Interface for config::outputScheme */
    OUTPUT_SCHEME getOutputScheme() const
    {
      return  outputScheme;
    }
    /** ------------------------------- */
    ...
    bool isHadronizationHQ() const
    {
      return hadronization_hq;
    }

    /** @brief Interface for config::mesonDecay */
    bool isMesonDecay() const
    {
      return mesonDecay;
    }

    /** @brief Interface for config::numberElectronStat */
    int getNumberElectronStat() const
    {
      return  numberElectronStat;
    }

    /** @brief Interface for config::muonsInsteadOfElectrons */
    bool isMuonsInsteadOfElectrons() const
    {
      return muonsInsteadOfElectrons;
    }

    /** @brief Interface for config::studyNonPromptJpsiInsteadOfElectrons */
    bool isStudyNonPromptJpsiInsteadOfElectrons() const
    {
      return studyNonPromptJpsiInsteadOfElectrons;
    }


    // Jpsi
    /** @brief Interface for config::isotropicCrossSecJpsi */
    bool isIsotropicCrossSecJpsi() const
    {
      return  isotropicCrossSecJpsi;
    }

    /** @brief Interface for config::constantCrossSecJpsi */
    bool isConstantCrossSecJpsi() const
    {
      return  constantCrossSecJpsi;
    }

    /** @brief Interface for config::constantCrossSecValueJpsi */
    double getConstantCrossSecValueJpsi() const
    {
      return  constantCrossSecValueJpsi;
    }

    /** @brief Interface for config::TdJpsi */
    double getTdJpsi() const
    {
      return  TdJpsi;
    }

    /** @brief Interface for config::jpsi_sigmaAbs */
    double getSigmaAbs() const
    {
      return jpsi_sigmaAbs;
    }

    /** @brief Interface for config::jpsi_agN */
    double getJpsiagN() const
    {
      return jpsi_agN;
    }

    /** @brief Interface for config::shadowing_model */
    shadowModelJpsi getShadowingModel() const
    {
      return shadowing_model;
    }

    /** @brief Interface for config::jpsi_formationTime */
    double getJpsiFormationTime() const
    {
      return jpsi_formationTime;
    }

    /** @brief Interface for config::jpsi_testparticles */
    int getJpsiTestparticles() const
    {
      return jpsi_testparticles;
    }


    // heavy quark output
    /** @brief Interface for config::hqCorrelationsOutput */
    bool isHqCorrelationsOutput() const
    {
      return hqCorrelationsOutput;
    }
    /** ------------------------------------ */

    /** -------- miscellaneous options ------- */
    bool repeatTimesteps() const
    {
      return switch_repeatTimesteps;
    }

    /** @brief Interface for config::interpolationBorder */
    double getMFPInterpolationBorder() const
    {
      return interpolationBorder;
    }

    /** @brief Interface for config::jetMfpComputationSwitch */
    JET_MFP_COMPUTATION_TYPE getJetMfpComputationType() const
    {
      return jetMfpComputationSwitch;
    }
    /** ------------------------------------ */
    ...
    string getPathdirOfflineData() const
    {
      return pathdirOfflineData;
    }

    /** @brief Interface for config::pathdirOfflineData, returns pointer to char */
    const char* getPathdirOfflineDataChar() const
    {
      return pathdirOfflineData.c_str();
    }

    /** @brief Interface for config::fixed_dt */
    double getFixed_dt() const
    {
      return fixed_dt;
    }
    /** @brief Interface for config::switch_fixed_dt */
    bool useFixed_dt() const
    {
      return switch_fixed_dt;
    }
    /** @brief Interface for config::factor_dt */
    double getFactor_dt() const
    {
      return factor_dt;
    }

    /** @brief Interface for config::numberOfParticlesToAdd */
    int getNumberOfParticlesToAdd() const
    {
      return numberOfParticlesToAdd;
    }
    /** @brief Interface for config::numberOfAddedEvents */
    int getNaddedEvents() const
    {
      return numberOfAddedEvents;
    }
    /** @brief Interface for config::minimumPT */
    double getMinimumPT() const
    {
      return minimumPT;
    }
    ...
    double getCentralRingRadius() const
    {
